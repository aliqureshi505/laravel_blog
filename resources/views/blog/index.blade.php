		...
		<div id="fh5co-portfolio">
			@foreach($data as $posts)
				...
				<div class="fh5co-portfolio-figure animate-box">
					<br><br>
					<img src="{{Storage::disk('local')->url($posts->image) }}" class="img-responsive" alt="no image here"> 
				</div>
				<div class="fh5co-portfolio-description">
					<h2><a href="post/{{ $posts->slug }}">{{$posts->Ttile}}</a></h2>
					<p>{!! substr(htmlspecialchars_decode($posts->content),0,200) !!}</p>
					<p><a href="post/{{ $posts->slug }}" class="btn btn-primary ">Read More...</a></p>
				</div>
			</div>
					...
					<div class="col-md-10 col-md-offset-1">
						<div class="row">
							...
							<div class="col-md-3 col-sm-6 col-xs-6 col-xxs-12 fh5co-staff to-animate">
								<figure>
								<img src="{{asset('blog/images/user.jpg')}}" alt="Free HTML5 Template by FREEHTML5.co" class="img-responsive">
								</figure>
								<h3>Will Barrow</h3>
							...
							<div class="col-md-3 col-sm-6 col-xs-6 col-xxs-12 fh5co-staff to-animate">
								<figure>
								<img src="{{asset('blog/images/user_2.jpg')}}" alt="Free HTML5 Template by FREEHTML5.co" class="img-responsive">
								</figure>
							...
							<div class="col-md-3 col-sm-6 col-xs-6 col-xxs-12 fh5co-staff to-animate">
								<figure>
								<img src="{{asset('blog/images/user_3.jpg')}}" alt="Free HTML5 Template by FREEHTML5.co" class="img-responsive">
								</figure>
								<h3>Hanson Deck</h3>
								<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. </p>
								<ul class="fh5co-social">
